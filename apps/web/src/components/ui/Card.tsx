  ...
  if (tilt || interactive) {
    ...
    return (
      <motion.div
        ...
        className={cn(
          "relative bg-white border border-[#E8F2EE] rounded-[20px] shadow-[0_2px_16px_0_rgba(61,90,84,0.07)]",
          hover && "hover:shadow-[0_8px_32px_0_rgba(61,90,84,0.12)]",
  ...
  return (
    <div
      className={cn(
        ...
        hover && "transition-all duration-300 ease-out hover:shadow-[0_8px_32px_0_rgba(61,90,84,0.12)] hover:-translate-y-0.5",
        glow && "ring-1 ring-[#B8D4C0]",
        paddings[padding],
        className
      )}
