...
export default function Hero() {
  ...
  return (
    <section className="snap-section relative flex min-h-screen flex-col items-center justify-start overflow-hidden bg-[#FCFCFA] px-6 pt-24 pb-12 lg:min-h-screen lg:pt-32 lg:pb-12">
      <AnimatedHero />
